...
public class FlappyBirdBird extends FlappyBirdBaseObject {
    ...
    public Bitmap getBm() {
        ...
        if(this.drop<0){
            ...
            return Bitmap.createBitmap(arrBms.get(idCurrentBitmap), 0, 0,
                    arrBms.get(idCurrentBitmap).getWidth(), arrBms.get(idCurrentBitmap).getHeight(), matrix, true);
